<x-filament-panels::page>
    <div class="mx-auto w-full space-y-4">
            ...
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div class="min-w-0">
                    <h2 class="text-base font-semibold text-gray-900 dark:text-white">
                        Materi Boarding: {{ $this->getRecord()->siswa?->nama ?? 'Murid' }}
                    </h2>
                </div>
        ...
        <section id="materi-boarding-editor" class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-gray-900">
