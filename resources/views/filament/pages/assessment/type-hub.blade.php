<x-filament-panels::page>
    ...
    <div class="space-y-6">
        ...
        @if ($period)
            <section class="grid grid-cols-2 gap-3 lg:grid-cols-4">
                @foreach ([
                    ...
                    <article class="min-w-0 rounded-xl border border-gray-200 bg-white p-3 shadow-sm sm:p-4 dark:border-white/10 dark:bg-gray-900">
                        <div class="flex min-w-0 items-center gap-3">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-300">
        ...
        @else
            <section class="rounded-2xl border border-dashed border-warning-300 bg-warning-50 p-5 dark:border-warning-500/30 dark:bg-warning-950/20">
