<style>
    ...
    * { box-sizing: border-box; }
    body { margin: 0; color: #111827; font-family: "Times New Roman", Times, serif; font-size: 12px; line-height: 1.2; }
    ...
    .report-footer { position: fixed; bottom: -8mm; left: 0; right: 0; color: #4b5563; font-size: 10px; text-align: center; }
    ...
    .letterhead__school-info { margin: 0; font-size: 12px; }
    .letterhead-rule { margin: 0 0 7px; border: 0; border-top: 1.5px solid #111827; }
    .report-title { margin: 0; text-align: center; font-size: 13px; font-weight: 700; }
    .report-subtitle { margin: 2px 0 8px; text-align: center; font-size: 12px; }
    ...
    .scores__predicate { width: 55px; text-align: center; } .scores__description { font-size: 12px; line-height: 1.15; }
    .empty-row { color: #6b7280; text-align: center; }
    .section-title { margin: 7px 0 3px; font-size: 12px; font-weight: 700; }
    ...
    .letterhead__foundation { margin: 0; font-size: 14px; font-weight: 700; }
    .letterhead--asts .letterhead__school-name { font-size: 14px; }
    ...
    .report-page--asts-scores .report-title { font-size: 13px; }
    .report-page--asts-scores .report-subtitle { margin: 1px 0 4px; font-size: 12px; }
    ...
    .asts-kktp-title { margin: 3px 0 2px; font-size: 12px; font-weight: 700; }
    ...
    .asts-kktp th span { font-size: 12px; font-weight: 400; }
    .asts-subject-group { margin: 4px 0 1px; font-size: 12px; font-weight: 700; }
    .asts-scores { margin-bottom: 2px; }
    .report-page--asts-summary .letterhead--asts { margin-bottom: 1px; }
    .asts-summary-title { margin: 0 0 2px; text-align: center; font-size: 13px; font-weight: 700; }
    .asts-summary-identity { margin-bottom: 5px; }
    .asts-summary-identity td { padding-top: 1px; padding-bottom: 1px; font-size: 12px; }
