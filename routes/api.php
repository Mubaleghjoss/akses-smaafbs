...
Route::prefix('/internal/student-sync')->middleware([
    ...
    Route::post('/preview', fn (Request $request) => response()->json([
        'message' => 'Student sync preview receiver is not implemented yet.',
        'client_id' => $request->attributes->get('student_sync_client_id'),
    ], 503))->name('api.internal.student-sync.preview');
